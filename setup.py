...
setup(
    ...
    url='https://github.com/erpbrasil/erpbrasil.febraban',
    ...
    project_urls={
        ...
        'Issue Tracker': 'https://github.com/erpbrasil/erpbrasil.febraban/issues',
    },
    keywords=[
    ...
    entry_points={
        'console_scripts': [
            'erpbrasil.febraban = erpbrasil.febraban.cli:main',
        ]
    },
)
